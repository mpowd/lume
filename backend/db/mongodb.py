...
class MongoDBClient:
    ...
    def persist_docs(
        self, docs: List[Dict[str, Any]], collection_name: str = "temp"
    ) -> List[str]:
        """
    ...
    def get_docs_by_url(
        self, source_url: str, collection_name: str = "temp"
    ) -> List[Dict[str, Any]]:
        """
    ...
    def update_document(
        self, doc_id: str, update_data: Dict[str, Any], collection_name: str = "temp"
    ) -> bool:
        """
    ...
    def delete_documents(
        self, filter_query: Dict[str, Any], collection_name: str = "temp"
    ) -> int:
        """
